...
available_dates = df_prices['Date'].dt.date.unique()
...
if not selected_dates:
    ...
    fig = px.line(df_filtered, x="Contract", y="Price", color="Date Label",
                  title="Naphtha Curves",
                  labels={"Contract": "Contract Month", "Price": "Naphtha Price ($)", "Date Label": "Selected Date"})
